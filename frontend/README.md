...
This React Native frontend (Expo) now lives in `frontend/` inside the combined repo and connects to the Shelvy backend and Firebase for authentication.
...
1. Install dependencies (run commands from `frontend/`):
